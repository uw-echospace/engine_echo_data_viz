...
function addTrajectoryToMap() {
    console.log('??? RE-ADDING TRAJECTORY', trajectoryPoints.length);
...
function setupEventListeners() {
    ...
    document.getElementById('vminSlider').addEventListener('change', function (e) {
        document.getElementById('vminValue').textContent = e.target.value;
        debouncedUpdate();
    });

    document.getElementById('vmaxSlider').addEventListener('change', function (e) {
    ...
    // "Generate" button still highlights trajectory + updates echogram
    document.getElementById('generateRangeEchogram').addEventListener('click', function () {
        updateHighlightedTrajectory();
        fetchEchogram();
    });

    // Update highlighted trajectory on time change
